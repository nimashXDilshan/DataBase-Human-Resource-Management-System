...
function Services() {
  return (
    <div className="services-page bg-gradient-to-r from-blue-900 via-indigo-800 to-blue-700 py-10 px-4 md:px-16 lg:px-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {/* Service 1 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Custom Design</h2>
        ...
        {/* Service 2 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Bulk Orders</h2>
          <p className="text-gray-300">
        ...
        {/* Service 3 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Sustainable Fashion</h2>
          <p className="text-gray-300">
        ...
        {/* Service 4 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Apparel Printing</h2>
          <p className="text-gray-300">
        ...
        {/* Service 5 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Fashion Consultation</h2>
          <p className="text-gray-300">
        ...
        {/* Service 6 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Private Labeling</h2>
          <p className="text-gray-300">
        ...
        {/* New Service 7 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">E-commerce Solutions</h2>
          <p className="text-gray-300">
        ...
        {/* New Service 8 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Digital Fashion Showcases</h2>
          <p className="text-gray-300">
        ...
        {/* New Service 9 */}
        <div className="service-card bg-gray-800 shadow-lg rounded-lg p-6 hover:bg-gray-700 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Branding and Marketing Support</h2>
          <p className="text-gray-300">
