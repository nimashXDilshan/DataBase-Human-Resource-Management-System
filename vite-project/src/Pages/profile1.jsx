...
>
  <div
    class="avatar w-full h-full pt-5 flex items-center justify-center flex-col gap-1"
  >
    <div
    ...
    >
      <svg
        class="size-32 z-40 border-4 border-white rounded-full group-hover:border-8 group-hover:transition-all group-hover:duration-300 transition-all duration-300"
        id="avatar"
