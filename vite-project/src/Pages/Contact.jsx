...
function ContactUs() {
  return (
    <div className="contact-page bg-gradient-to-r from-gray-900 to-navy-900 py-12 px-4 md:px-16 lg:px-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-gray-800 shadow-lg rounded-lg p-8 hover:bg-gray-700 transition-all duration-300">
          ...
          <form className="space-y-6">
            ...
            <div>
              <label className="block text-gray-300 font-medium mb-2" htmlFor="message">Your Message</label>
              <textarea
                id="message"
                rows="4"
                className="w-full p-3 rounded border-2 border-gray-600 focus:border-blue-500 outline-none transition duration-200 bg-gray-900 text-white"
      ...
      {/* Map Section */}
      <div className="mt-12">
        <h2 className="text-3xl font-semibold text-center text-white mb-6">Our Location</h2>
        <div className="flex justify-center">
          <iframe
            ...
            className="w-full h-80 rounded-lg shadow-lg border-2 border-blue-500"
            allowFullScreen=""
            loading="lazy"
          ></iframe>
        </div>
